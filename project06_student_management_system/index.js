...
class StudentManagementSystem {
    manageStudent = [];
    async addStudents(name, fatherName, age) {
        let balance = 10000;
        ...
        if (!isNaN(age)) {
            ...
            console.log(`${chalk.yellow("Student Info added successdully")}\nname: ${name}\nfather name: ${fatherName}\nage: ${age}\nstudent id: ${studentId}\nbalance:${balance}`);
        }
        else {
    ...
    async showStudents() {
        if (this.manageStudent.length !== 0) {
            this.manageStudent.forEach((studentInfo) => console.log(chalk.yellow(`name: ${studentInfo.name}\nfather name: ${studentInfo.fatherName}\nage: ${studentInfo.age}\nstudent id: ${studentInfo.studentId}\nbalance: ${studentInfo.balance}`)));
        }
        else {
    ...
    async deleteStudents() {
        if (this.manageStudent.length !== 0) {
            ...
            let isId = true;
            let student = this.manageStudent.find((student) => {
                ...
                switch (selectCourses.options) {
                    case chalk.bold("TypeScript\nRs:500"):
                        if (student.enrolledCourse?.includes("TypeScript") !== true) {
                            if (student.balance > 500) {
                                student.balance -= 500;
                                console.log(chalk.bold(`congrats now your enrolled in ${chalk.yellow("TypeScript Course")}\ncourse duration: ${chalk.yellow("3 Months")}\nCourse charges: ${chalk.yellow("500")}\nremaining balance: ${chalk.yellow(student.balance)}`));
                    ...
                    case chalk.bold("Python\nRs:800"):
                        if (student.enrolledCourse?.includes("Python") !== true) {
                            if (student.balance > 800) {
                                student.balance -= 800;
                                console.log(chalk.bold(`congrats now your enrolled in ${chalk.yellow("Python Course")}\ncourse duration: ${chalk.yellow("2 Months")}\nCourse charges: ${chalk.yellow("800")}\nremaining balance: ${chalk.yellow(student.balance)}`));
                                if (student.hasOwnProperty("enrolledCourse") !== true) {
                    ...
                    case chalk.bold("C++\nRs:900"):
                        if (student.enrolledCourse?.includes("C++") !== true) {
                            if (student.balance > 900) {
                                student.balance -= 900;
                                console.log(chalk.bold(`congrats now your enrolled in ${chalk.yellow("C++ Course")}\ncourse duration: ${chalk.yellow("3 Months")}\nCourse charges: ${chalk.yellow("900")}\nremaining balance: ${chalk.yellow(student.balance)}`));
                                if (student.hasOwnProperty("enrolledCourse") !== true) {
                    ...
                    case chalk.bold("Java\nRs:1000"):
                        if (student.enrolledCourse?.includes("Java") !== true) {
                            if (student.balance > 1000) {
                                ...
                                console.log(chalk.bold(`congrats now your enrolled in ${chalk.yellow("Java Course")}\ncourse duration: ${chalk.yellow("2 Months")}\nCourse charges: ${chalk.yellow("1000")}\nremaining balance: ${chalk.yellow(student.balance)}`));
                                if (student.hasOwnProperty("enrolledCourse") !== true) {
                    ...
                    case chalk.bold("JavaScript\nRs:1100"):
                        if (student.enrolledCourse?.includes("JavaScript") !== true) {
                            if (student.balance > 1100) {
                                student.balance -= 1100;
                                console.log(chalk.bold(`congrats now your enrolled in ${chalk.yellow("JavaScript Course")}\ncourse duration: ${chalk.yellow("3 Months")}\nCourse charges: ${chalk.yellow("1100")}\nremaining balance: ${chalk.yellow(student.balance)}`));
                                if (student.hasOwnProperty("enrolledCourse") !== true) {
                    ...
                    case chalk.bold("Nextjs\nRs:1500"):
                        if (student.enrolledCourse?.includes("Nextjs") !== true) {
                            if (student.balance > 1500) {
                                student.balance -= 1500;
                                console.log(chalk.bold(`congrats now your enrolled in ${chalk.yellow("Nextjs Course")}\ncourse duration: ${chalk.yellow("4 Months")}\nCourse charges: ${chalk.yellow("1500")}\nremaining balance: ${chalk.yellow(student.balance)}`));
                                if (student.hasOwnProperty("enrolledCourse") !== true) {
        ...
        if (this.manageStudent.length !== 0) {
            ...
            if (student?.studentId == getId.id && !isId) {
                ...
                if (!isNaN(getAmount.amount)) {
                    ...
                    console.log(chalk.bold(`Amount ${chalk.yellow(getAmount.amount)} added successfully\ncurrent balance is: ${chalk.yellow(student.balance)}`));
                }
                else {
                    console.log(chalk.red("Please enter valid id"));
                }
    ...
    async payDues() {
        if (this.manageStudent.length !== 0) {
            ...
            if (student?.studentId == getId.id && !isId) {
                let getFess = await inquirer.prompt({
                    name: "fees",
                ...
                if (!isNaN(getFess.fees)) {
                    ...
                    console.log(chalk.bold(`Fess paid ${chalk.yellow(getFess.fees)} successfully\nCurrent fees paid: ${chalk.yellow(student.feesPaid)}`));
                }
                else {
                    console.log(chalk.red("Please enter valid amount"));
                }
        ...
        while (flage) {
            ...
            switch (choice.choice) {
                case chalk.bold("Add student info"):
                    ...
                    await this.addStudents(getStudentInfo.name, getStudentInfo.fatherName, getStudentInfo.age);
                    break;
...
let student = new StudentManagementSystem();
student.main();

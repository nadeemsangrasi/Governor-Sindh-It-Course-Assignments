...
let customer = new MyBank(10000);
let viewInfo = async (userId) => {
    let accountsInfo = {
        1234: {
            firstName: "Naddeem",
            lastName: "Sangrasi",
        ...
        3344: {
            ...
            gender: "female",
            age: 16,
            mobileNumber: 92301055601
        },
    };
    let userInfo = accountsInfo[userId];
    let customerInfo = new Customers(userInfo.firstName, userInfo.lastName, userInfo.gender, userInfo.age, userInfo.mobileNumber);
    customerInfo.displayInfo();
};
async function main() {
    let customersAccountNums = [1234, 5678, 1122, 3344];
